programa {
  funcao inicio() {
    ...
    caso 1:
    escreva("A vista em dinheiro ou cheque, 10% de desconto")
    escreva("\nValor Total: " , valorEtiqueta * 0.9)
    pare

    caso 2:
    escreva("A vista no cartão de credito, 5% de desconto")
    escreva("\nValor Total: " , valorEtiqueta * 0.95)
    pare

    caso 3:
    escreva("Em duas vezes, preço normal de etiqueta sem juros")
    escreva("\nValor Total: " , valorEtiqueta/2)
    pare

    caso 4:
    escreva("Em três vezes, preço normal de etiqueta mais juros de 10%")
    escreva("\nValor Total: " , valorEtiqueta * 1.10)
    pare
